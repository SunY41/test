...
--%>
<%--<%@page import="com.xiaobai.service.GoodsService" %>--%>
<%--<%@page import="com.xiaobai.service.GoodsTypeService" %>--%>
<%--<%@page import="com.xiaobai.service.impl.GoodsServiceImpl" %>--%>
<%--<%@page import="com.xiaobai.service.impl.GoodsTypeServiceImpl" %>--%>
...
<script>
    ...
    function showAdd() {
        location.href = "/test_sy/after/add_goods.jsp";
    }
    ...
    function delectAll() {
        if (confirm("确定删除吗？")) {
            ...
            window.location.href = "/test_sy/DeleteGoodsServlet?goodsid=" + ids;
        }
    ...
    function showName(obj, id) {
        ...
        $("#typeName").val(name);
        $("#typeId").val(id);
        //var stuids=document.getElementById("show").value.innerHTML=${goods.typename};
    }
...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <button type="button" onclick="showAdd()" id="addBtn" class="btn btn-info">添加商品
            </button>
        ...
        <div class="col-md-6" style="text-align: right; padding-right: 25px;">
            <form class="form-inline" action="<%=path%>/FuzzySelectGoods" >
                ...
                <div class="form-group">
                    <input type="date" class="form-control" id="exampleInputTimw" placeholder="年/月/日" name="deployDate">
                </div>

                <div class="form-group">
                    <div class="dropdown">
                        <input class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true"
            ...
            <c:forEach items="${list}" var="goods" varStatus="obj">
                <tr>
                    ...
                    <td>${goods.price}</td>
                        <%-- ${goods.imgPath} --%>
                    <td>
                        <img src="${goods.imgPath}" class="img-rounded" height="50px" width="50px"/></td>
                    ...
                    <td>
                        <button type="button" class="btn btn-primary"
                                ...
                                data-content="${goods.comment}！">弹详情
                        </button>
                    </td>
...
<div class="container">
    <nav aria-label="..." class="navbar-right" style="margin-right: 15px">
        <ul class="pagination">
            ...
            %>
            <li><a class=" btn-info"
                   href="<%=path %>/FuzzySelectGoods?pageNo=${pageNo-1}&username=${user.username}&typeId=${typeId}"
            ...
            <li><a class=" btn-info"
                   href="<%=path %>/FuzzySelectGoods?pageNo=${pageNo}&username=${user.username}&typeId=${typeId}">${pageNo}</a>
            </li>
            <li class="disabled"><a href="#" aria-label="Previous">»<span
                    class="sr-only">(current) </span></a></li>
            <%
