...
<%--<%--%>
<%--    GoodsTypeServiceImpl gt = new GoodsTypeServiceImpl();--%>

<%--    List<GoodsType> goodsTypes = gt.TypeSelect();--%>
<%--    List<GoodsType> typeList=gt.TypeSelect();--%>
<%--    request.setAttribute("typeList",goodsTypes);--%>
<%
    GoodsTypeServiceImpl goodsTypeService = new GoodsTypeServiceImpl();
    List<GoodsType> list = goodsTypeService.selectType();
...
<%--        Goods goods = gs.getGoodsById(id1);--%>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                <li>
                    <a href="<%=path%>/FuzzySelectGoods">商品管理 <span class="sr-only">(current)</span></a>
                </li>
                <li>
                    <a href="<%=path%>/GoodsTypeSelectServlet">商品类型管理</a>
                </li>
                <li>
                    <a href="<%=path%>/UserFuzzyServlet">用户管理</a>
                </li>
                <li>
                    <a href="<%=path%>/OrderFuzzySelectServlet">订单管理</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/before/index.html">直通锋迷网</a>
                </li>
            </ul>

            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="<%=path%>/after/login.jsp">${manageName}</a>
                </li>
                <li>
                    <a href="#">
                ...
                <li>
                    <a href="<%=path%>/LogOutServlet" style="padding-left: 0px">退出</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
...
<div class="container" style="margin-top: 20px;">
    <form class="form-horizontal" enctype="multipart/form-data"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="price" id="price" value="${goods.price}"
                       placeholder="价格,默认为9999" onblur="return check()">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <c:if test="${not empty goods.imgPath}">
                    <img src="${goods.imgPath}" id="portrait" alt="..." class="img-thumbnail" height="130px"
                         width="130px">
                </c:if>
                <c:if test="${empty goods.imgPath}">
                    <img src="${pageContext.request.contextPath}/images/default.jpg" id="portrait" alt="..."
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="comment" rows="3" value="请输入描述">${goods.comment}</textarea>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="button" onclick="return submit()" class="btn btn-default">保存
                </button>
            </div>
        </div>
    </form>
